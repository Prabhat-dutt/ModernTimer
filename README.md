...
A sleek, minimal, and highly customizable Countdown Timer & Stopwatch desktop widget for **Rainmeter**, featuring modern typography, dynamic theme switching, and interactive task management.
...
- **ℹ️ Author Info Overlay**: Quick access info panel with version info and project links.
...
- **Toggle Info View**: Click the `i` icon in the top left corner.
